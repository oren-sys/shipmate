...
export const AE_CATEGORIES: Record<string, { id: string; feedName: string; nameEn: string; nameHe: string }> = {
  ...
  fashion: { id: "3", feedName: "DS_Fashions&Cosmetics 20$+", nameEn: "Apparel & Accessories", nameHe: "אופנה" },
  ...
  kids: { id: "1501", feedName: "DS_Mother&Kids 10$+", nameEn: "Mother & Kids", nameHe: "ילדים" },
  gadgets: { id: "509", feedName: "AEB_ PhoneAccessories_EG", nameEn: "Phones & Accessories", nameHe: "גאדג׳טים" },
  ...
  jewelry: { id: "36", feedName: "DS_Jewelry&Watch 10$+", nameEn: "Jewelry & Accessories", nameHe: "תכשיטים" },
  toys: { id: "26", feedName: "DS_Global_topsellers", nameEn: "Toys & Hobbies", nameHe: "צעצועים" },
};

/* Default feed for "all categories" scanning */
export const AE_DEFAULT_FEED = "AEB_Droplo_BestsellersItems_20241016";
